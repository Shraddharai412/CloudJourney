		...
		{	
			if(isset($_POST['destination']) && !empty($_POST['destination']))
			{
				if(isset($_POST['date']) && !empty($_POST['date']))
				{
					...
					$date=$_POST['date'];
					$query=mysqli_query($con,("SELECT ARRIVAL,DEPARTURE,DURATION,FLIGHT_CODE,AIRLINE_ID,`PRICE(BUSINESS)`,`PRICE(ECONOMY)`,`PRICE(STUDENT)`,`PRICE(DIFF)` from flight where SOURCE='$source' && DESTINATION='$destination' && DATE='$date'"));
	...
	<table class="a">
		...
		?>
				<tr>
						...
						<td><?php echo $rows['PRICE(BUSINESS)']?></td>
				...
				<tr>
						...
						<td><?php echo $rows['FLIGHT_CODE']?></td>
						<td><?php echo $rows['AIRLINE_ID']?></td>
						<td><?php echo $rows['PRICE(ECONOMY)']?></td>
				...
				<tr>
						...
						<td><?php echo $rows['FLIGHT_CODE']?></td>
						<td><?php echo $rows['AIRLINE_ID']?></td>
						<td><?php echo $rows['PRICE(STUDENT)']?></td>
				...
				<tr>
						...
						<td><?php echo $rows['FLIGHT_CODE']?></td>
						<td><?php echo $rows['AIRLINE_ID']?></td>
						<td><?php echo $rows['PRICE(DIFF)']?></td>
